...
function Hero() {
  return (
        <div className="flex gap-[5px]">
            <div className="w-[590px] h-[300px] pt-[25px] bg-[url('./src/assets/hero1.svg')] pl-[25px] text-white">
            ...
            <div className="w-[293px] h-[300px] bg-[url('./src/assets/hero2.svg')] flex flex-col justify-center p-4 pt-[220px] text-white">
                <p className="text-[16px] text-[#FD9339]">Рецепты</p>
                <p className="text-[22px] font-bold">Сыры с плесенью</p>
            </div>
            <div className="w-[293px] h-[300px] bg-[url('./src/assets/hero3.svg')] flex flex-col justify-center p-4 pt-[220px] text-white">
