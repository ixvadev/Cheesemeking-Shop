  ...
  return (
    <div className="">
        ...
        <div className="flex">
          ...
          <div className="text-[13px] text-[#808080] flex gap-[20px] ml-3">
            <div className="flex items-center space-x-2">
              <img
                src="/src/assets/svg/Бесплатная доставка.svg"
            ...
            <div className="flex items-center space-x-2">
              <img
                src="/src/assets/svg/Скидка при оплате на сайте.svg"
                alt="Скидка при оплате на сайте"
                className="h-6"
              />
              <a href="">
                Скидка при <br /> оплате на сайте
              </a>
            </div>
            <div className="flex items-center space-x-2">
              <img
                src="/src/assets/svg/Защита покупателей.svg"
                alt="Защита покупателей"
                className="h-6"
              />
              <a href="" className="leading-tight">
                Защита <br /> покупателей
              </a>
            </div>
          </div>
        </div>
        ...
        <div className="flex gap-[20px] items-center">
          ...
          <div className="flex gap-[20px] items-center">
            <div className="items-center space-x-2">
              <div className="">
                <a
                  href="tel:+8 916 460-19-60"
                  className="text-[#4E2D2D] text-[16px] my-[10px] font-semibold"
                >
                  +8 916 460-19-60
                </a>
            ...
            <div className="flex items-center gap-[20px]">
              <div className="pl-[20px]">
                ...
                <a
                  href=""
                  className=" text-[#FD9339] text-[14px] my-[3] flex justify-end"
                >
                  1680 руб.
                </a>
              </div>
              <Link to={"/khujamov-shop/cart"}>
                <img
                  src="/src/assets/svg/shopping-cart add.svg"
                  alt="Cart"
                  className="h-[48px]"
                />
                <span className="ml-[40px] px-[10px] absolute mt-[-50px] text-[#ffffff] bg-[#F97316] rounded-full">{length}</span>
              </Link>
            </div>
          </div>
        </div>
      ...
      <div className="contianer flex py-[10px] justify-between">
        ...
        <div className="flex">
          <img
            className="absolute ml-[10px] mt-[6px]"
            src="/src/assets/svg/search-loupe.svg"
            alt=""
          />
          <input
            type="search"
            id="default-search"
            className="block w-[300px] px-5 ps-10 py-2 text-sm bg-inherit outline-none rounded-lg border border-solid border-[#FD9339]"
